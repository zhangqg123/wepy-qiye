...
//客户业务后台请求域名，用于获取IM信息
 var GetTestLoginInfoUrl = wepy.$instance.globalData.baseUrl2;
//var GetTestLoginInfoUrl = "http://192.168.0.199:8080/jeecg";
...
function proto_getLoginInfo(options) {
  wx.request({
    url: GetTestLoginInfoUrl + '/work/wxpay/get_login_info.do',

var liveroom = require('../../api/mlvbliveroomcore.js');
...
Page({
  ...
  create: function () {
    ...
    var url = './roomname?page=' + self.data.roomPageType + '&type=create&roomName=' + self.data.roomName + '&userName=' + self.data.userName;
    wx.navigateTo({
      url: url
    });
  ...
  goRoom: function (e) {
    ...
    var url = './room?roomID=' + e.currentTarget.dataset.roomid + '&roomName=' + e.currentTarget.dataset.roomname + '&userName=' + this.data.userName + '&accelerateURL=' + e.currentTarget.dataset.accelerateurl;
  ...
  onReady: function () {
    ...
    getlogininfo.getLoginInfo({
      success: function (ret) {
        console.log('获取IM登录信息成功222: ', ret.data);
        var loginInfo = {
